...
now lets go into _layouts/default.html and look for "</head>" delete everything below it and replace with <div class="language-html highlighter-rouge"> <code><header class="page-header"  
        role="banner">
